...
**REQUIRED BACKGROUND:** Read jackal-extending-claude:writing-claude-directives for foundational guidance on token efficiency, discovery optimization, and compliance techniques. This skill focuses on TDD methodology specific to skill creation.
...
**REQUIRED:** Use jackal-extending-claude:testing-skills-with-subagents for complete methodology.
