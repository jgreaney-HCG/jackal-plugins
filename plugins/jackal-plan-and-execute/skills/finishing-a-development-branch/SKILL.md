...
Before merging or creating a PR, invoke `jackal-extending-claude:project-claude-librarian` to update CLAUDE.md files if contracts or structure changed.
...
**If librarian subagent is not available:** skip this step, saying aloud that you're skipping it because the `jackal-extending-claude` plugin is not available.
