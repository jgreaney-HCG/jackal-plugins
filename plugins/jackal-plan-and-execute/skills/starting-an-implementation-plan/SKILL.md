...
(conditional) TaskCreate: "Read project implementation guidance from [absolute path]"
  ...
  → (only if .jackal/implementation-plan-guidance.md exists)
...
**Check if `.jackal/implementation-plan-guidance.md` exists:**

Use the Read tool to check if `.jackal/implementation-plan-guidance.md` exists in the session's working directory.

**If the file exists:**

1. Use TaskCreate to add: "Read project implementation guidance from [absolute path to .jackal/implementation-plan-guidance.md]"
